...
Modis is a community-driven open source project and we welcome all the contributors.
...
> **Note:**
>
> This section takes creating a PR to the `main` branch as an example. The steps of creating PRs for other branches are similar.
